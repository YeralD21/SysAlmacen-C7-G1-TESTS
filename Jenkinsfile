        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/YeralD21/SysAlmacen-C7-G1-TESTS.git'
                }
            }
        }
        stage('Build') {
